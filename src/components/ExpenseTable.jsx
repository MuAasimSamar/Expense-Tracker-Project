...
function ExpenseTable({ expenses, setExpense, setExpenses, setEditingRowId }) {
  ...
  const [sortCallback, setSortCallback] = useState(() => {
    return () => {};
  }); //this is another type to define the state and initially sortCallback value is function return value(here sortCallback state value is empty function).
    ...
    <>
      ...
      <table className="expense-table" onClick={() => setMenuPosition({})}>
        ...
        <tbody>
          ...
          <tr  style={{backgroundColor:'#747171'}}>
            <th>Total</th>
            <th
